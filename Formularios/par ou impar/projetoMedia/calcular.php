...
?>
    ...
    <div class="container-fluid-width pb-3">
        ...
        <h1 class="centro mt-3">Calculo da Média</h1>
            ...
            <div class="col-12 pb-3">
                <form>
                    <div class="form-group">
                        ...
                        <input class="form-control" value="<?php echo $valor; ?>" disabled>
                    </div>
                    <div class="form-group">
                        <label for="senha"> Resultado:</label>
                        <input class="form-control " value="<?php echo $resultado; ?>" disabled>
                    </div>
                    <bnt class="btn btn-primary"><a href="ImparPar.html" style="color:white">Voltar</a></bnt>
                </form>         
            </div>
        </div>
    </div>
