...
?>
    ...
    <div class="container-fluid-width pb-3">
        ...
        <h1 class="centro mt-3">Cálculo da Tabuada</h1>
            ...
            <div class="col-12 pb-3">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        do{
                            $cont=($tab*$num);
                            echo "<option> $tab x $num = $cont </option>";
                            $num++;
                        }while($num<=10); ?> 
                        </select>
                    </div>
                    <bnt class="btn btn-primary"><a href="tabuada.html" style="color:white">Voltar</a></bnt>
                </form>         
            </div>
        </div>
    </div>
